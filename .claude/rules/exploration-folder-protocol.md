...
1. **Create** -- `mkdir -p explorations/[name]/{src,output}` + README from `templates/exploration-readme.md`
2. **Develop** -- work entirely within the exploration folder
3. **Decide:**

   - **Graduate to production** -- copy to `src/`; requires quality >= 80, tests pass, code clear. Move to `ARCHIVE/completed_[project]/`
